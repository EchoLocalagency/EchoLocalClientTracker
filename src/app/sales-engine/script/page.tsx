...
Keep it under 20 seconds. No pitch, no details, no pressure. Just enough curiosity to get a callback. "One business in [AREA]" creates scarcity. "Shoot me a text" is lower friction than calling back. Always repeat the number.`,
  },
  {
    ...
    content: `"So I'll be honest, it's kind of hard to explain in a sentence because it does a lot. But basically I built a living system that works on your website and your Google Business Profile every single day to get you showing up more. It posts your work, handles your reviews, builds out pages for every city you serve -- [NEARBY CITY 1], [NEARBY CITY 2], all of them -- and it just keeps compounding over time. The more it runs, the more you show up, the more calls you get.
