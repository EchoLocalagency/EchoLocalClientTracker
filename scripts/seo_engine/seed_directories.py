...
Trade tags:
  - (empty): Universal -- relevant to ALL local businesses
  - pressure_washing: Pressure/power washing, soft washing, exterior cleaning
  - turf: Artificial turf cleaning/installation, synthetic grass
  - landscaping: Landscaping, lawn care, hardscaping, outdoor living
  - home_services: General home services (cleaning, maintenance, repairs)
  - seo_agency: SEO/marketing agencies (Echo Local only)
...
DIRECTORIES = [
    ...
    # Universal -- every local business should be listed here
    ...
    # Home services -- pressure washing, turf, landscaping
    {"name": "Angi", "domain": "angi.com", "submission_url": "https://www.angi.com/pro/signup", "tier": 1, "trades": ["pressure_washing", "turf", "landscaping", "home_services"], "da_score": 80, "submission_method": "web_form"},
    {"name": "HomeAdvisor", "domain": "homeadvisor.com", "submission_url": "https://pro.homeadvisor.com/", "tier": 1, "trades": ["pressure_washing", "turf", "landscaping", "home_services"], "da_score": 78, "submission_method": "web_form"},
    {"name": "Houzz", "domain": "houzz.com", "submission_url": "https://www.houzz.com/professionals/signup", "tier": 1, "trades": ["pressure_washing", "landscaping", "home_services"], "da_score": 89, "submission_method": "web_form"},
    {"name": "Thumbtack", "domain": "thumbtack.com", "submission_url": "https://www.thumbtack.com/pro/signup", "tier": 1, "trades": ["pressure_washing", "turf", "landscaping", "home_services"], "da_score": 80, "submission_method": "web_form"},
    ...
    {"name": "Expertise.com", "domain": "expertise.com", "submission_url": "https://www.expertise.com/claim", "tier": 2, "trades": ["pressure_washing", "turf", "landscaping", "home_services"], "da_score": 48, "submission_method": "web_form"},
    {"name": "Bark", "domain": "bark.com", "submission_url": "https://www.bark.com/en/us/register/pro/", "tier": 2, "trades": ["pressure_washing", "turf", "landscaping", "home_services"], "da_score": 47, "submission_method": "web_form"},
    {"name": "Porch", "domain": "porch.com", "submission_url": "https://pro.porch.com/", "tier": 2, "trades": ["pressure_washing", "landscaping", "home_services"], "da_score": 60, "submission_method": "web_form"},
    {"name": "ProMatcher", "domain": "promatcher.com", "submission_url": "https://www.promatcher.com/contractors/signup", "tier": 2, "trades": ["pressure_washing", "turf", "landscaping", "home_services"], "da_score": 34, "submission_method": "web_form"},
    {"name": "GuildQuality", "domain": "guildquality.com", "submission_url": "https://www.guildquality.com/get-started", "tier": 2, "trades": ["pressure_washing", "landscaping", "home_services"], "da_score": 36, "submission_method": "web_form"},
    {"name": "FindAContractor", "domain": "findacontractor.com", "submission_url": "https://www.findacontractor.com/register", "tier": 2, "trades": ["pressure_washing", "landscaping", "home_services"], "da_score": 30, "submission_method": "web_form"},

    # Lawn/turf/landscaping specific
    ...
    {"name": "LawnGuru", "domain": "lawnguru.co", "submission_url": "https://www.lawnguru.co/providers", "tier": 2, "trades": ["turf", "landscaping"], "da_score": 30, "submission_method": "web_form"},
    {"name": "Lawn Love", "domain": "lawnlove.com", "submission_url": "https://lawnlove.com/pro", "tier": 2, "trades": ["turf", "landscaping"], "da_score": 38, "submission_method": "web_form"},

    # Pressure washing specific
    {"name": "UAMCC Directory", "domain": "uamcc.org", "submission_url": "https://www.uamcc.org/join", "tier": 2, "trades": ["pressure_washing"], "da_score": 32, "submission_method": "web_form"},
    {"name": "PWNA Directory", "domain": "pwna.org", "submission_url": "https://www.pwna.org/join", "tier": 2, "trades": ["pressure_washing"], "da_score": 30, "submission_method": "web_form"},
    ...
    # SEO/Agency directories (Echo Local only)
    {"name": "Clutch", "domain": "clutch.co", "submission_url": "https://clutch.co/register", "tier": 2, "trades": ["seo_agency"], "da_score": 62, "submission_method": "web_form"},
    {"name": "DesignRush", "domain": "designrush.com", "submission_url": "https://www.designrush.com/agency/register", "tier": 2, "trades": ["seo_agency"], "da_score": 42, "submission_method": "web_form"},

    # =========================================================================
    # TIER 3: DA 10-30, auto-eligible (20 directories)
    # =========================================================================

    # Universal general directories
    ...
    # Pressure washing specific (Tier 3)
    ...
    {"name": "SoftWashSystems Directory", "domain": "softwashsystems.com", "submission_url": "https://softwashsystems.com/certified-applicator-map/", "tier": 3, "trades": ["pressure_washing"], "da_score": 18, "submission_method": "web_form"},

    # Turf/landscaping specific (Tier 3)
...
def seed_directories():
    ...
    for d in DIRECTORIES:
        ...
        trades_str = ", ".join(d.get("trades", [])) or "universal"
        print(f"  [OK] {d['name']:<30} (Tier {d['tier']}, DA {d.get('da_score', '?')}, trades: {trades_str})")
